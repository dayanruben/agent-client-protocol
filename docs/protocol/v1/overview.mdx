...
<ResponseField
  name="initialize"
  post={[<a href="/protocol/v1/schema#initialize">Schema</a>]}
>
...
<ResponseField
  name="authenticate"
  post={[<a href="/protocol/v1/schema#authenticate">Schema</a>]}
>
...
<ResponseField
  name="session/new"
  post={[<a href="/protocol/v1/schema#session%2Fnew">Schema</a>]}
>
...
<ResponseField
  name="session/prompt"
  post={[<a href="/protocol/v1/schema#session%2Fprompt">Schema</a>]}
>
...
<ResponseField
  name="session/load"
  post={[<a href="/protocol/v1/schema#session%2Fload">Schema</a>]}
>
...
<ResponseField
  name="logout"
  post={[<a href="/protocol/v1/schema#logout">Schema</a>]}
>
...
<ResponseField
  ...
  post={[<a href="/protocol/v1/schema#session%2Fset-mode">Schema</a>]}
>
...
<ResponseField
  name="session/cancel"
  post={[<a href="/protocol/v1/schema#session%2Fcancel">Schema</a>]}
>
...
<ResponseField
  ...
  post={[<a href="/protocol/v1/schema#session%2Frequest_permission">Schema</a>]}
>
...
<ResponseField
  ...
  post={[<a href="/protocol/v1/schema#fs%2Fread_text_file">Schema</a>]}
>
...
<ResponseField
  ...
  post={[<a href="/protocol/v1/schema#fs%2Fwrite_text_file">Schema</a>]}
>
...
<ResponseField
  ...
  post={[<a href="/protocol/v1/schema#terminal%2Fcreate">Schema</a>]}
>
...
<ResponseField
  ...
  post={[<a href="/protocol/v1/schema#terminal%2Foutput">Schema</a>]}
>
...
<ResponseField
  ...
  post={[<a href="/protocol/v1/schema#terminal%2Frelease">Schema</a>]}
>
...
<ResponseField
  ...
  post={[<a href="/protocol/v1/schema#terminal%2Fwait_for_exit">Schema</a>]}
>
...
<ResponseField
  name="terminal/kill"
  post={[<a href="/protocol/v1/schema#terminal%2Fkill">Schema</a>]}
>
...
<ResponseField
  name="session/update"
  post={[<a href="/protocol/v1/schema#session%2Fupdate">Schema</a>]}
>
