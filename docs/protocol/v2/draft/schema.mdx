...
See protocol docs: [Session Modes](https://agentclientprotocol.com/protocol/v2/draft/session-modes)
...
See protocol docs: [Client](https://agentclientprotocol.com/protocol/v2/draft/overview#client)
...
See protocol docs: [Terminals](https://agentclientprotocol.com/protocol/v2/draft/terminals)
...
See protocol docs: [FileSystem](https://agentclientprotocol.com/protocol/v2/draft/initialization#filesystem)
...
See protocol docs: [Terminal](https://agentclientprotocol.com/protocol/v2/draft/terminals)
