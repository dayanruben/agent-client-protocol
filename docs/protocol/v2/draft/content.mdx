...
- Language model output streamed through [`session/update`](/protocol/v2/draft/prompt-turn#3-agent-reports-output) notifications
- Progress updates and results from [tool calls](/protocol/v2/draft/tool-calls)
