...
- User prompts sent via [`session/prompt`](/protocol/v2/draft/prompt-lifecycle#1-user-message)
- Language model output reported through [`session/update`](/protocol/v2/draft/prompt-lifecycle#3-agent-reports-output) notifications as message updates or streamed chunks
