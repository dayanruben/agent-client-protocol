...
[initialization](/protocol/v2/draft/initialization). Agents advertise available
...
The Preview `terminal` type tells the Client to run the configured Agent program
interactively:
...
See the [draft schema](/protocol/v2/draft/schema#authmethod) for the full
