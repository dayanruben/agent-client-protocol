...
Cancellation **MAY** also be done explicitly on a per-feature basis within the protocol to cover specific scenarios (e.g., cancellation of [active session work](/protocol/v2/draft/prompt-lifecycle#cancellation)).
