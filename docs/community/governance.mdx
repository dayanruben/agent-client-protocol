...
- Companies and individuals with relevant expertise may contact Zed for component-specific administration rights
  ...
  - Companies or individuals interested in administration may contact Zed via [Zulip](https://agentclientprotocol.zulipchat.com/), shared Slack channel, or at hi@zed.dev
